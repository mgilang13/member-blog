...
!(function (e, t) {
        ...
        function Te(e) {
            for (
                ...
                if ((n = r.relative[e[s].type])) d = [me(be(d), n)];
                    ...
                    if (
                        (n = r.filter[e[s].type].apply(null, e[s].matches))[x]
                    ) {
                        for (i = ++s; i < o; i++)
    ...
    (w.filter = function (e, t, n) {
        ...
        w.fn.extend({
            ...
            is: function (e) {
                return !!L(
                    this,
                    "string" == typeof e && A.test(e) ? w(e) : e || [],
                    !1
                ).length;
            },
        });
    ...
    function He(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            J.hasData(e) &&
                ((u = J.access(e)), (s = w.extend({}, u)), J.set(t, s));
        }
    }
    function Ie(e, t) {
        var n = t.nodeName.toLowerCase();
    ...
    function Re(e, t, n, r) {
        ...
        if (
            ...
            if (s)
                for (
                    c = u[u.length - 1].ownerDocument, w.map(u, Pe), f = 0;
                    f < s;
                    f++
                )
                    (l = u[f]),
    ...
    w.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (t)
                if (n)
                    for (
                        o = o || ve(e), a = a || ve(u), r = 0, i = o.length;
                        r < i;
                        r++
                    )
                        He(o[r], a[r]);
            ...
            if (
                ...
                while ((u = y[a++]) && !t.isPropagationStopped())
                    (h = u),
                        ...
                        (d =
                            (K.get(u, "events") || {})[t.type] &&
                            K.get(u, "handle")) && d.apply(u, n),
                        (d = c && u[c]) &&
                            d.apply &&
                            Y(u) &&
                    ...
                    o ||
                        ...
                        (c &&
                            ...
                            t.isPropagationStopped() &&
                                h.addEventListener(m, ct),
                            i[m](),
                            t.isPropagationStopped() &&
                                h.removeEventListener(m, ct),
